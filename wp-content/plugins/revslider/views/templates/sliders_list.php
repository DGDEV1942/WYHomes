	...
	<table class='wp-list-table widefat fixed unite_table_items'>
		<thead>
			<tr>
				<th width='40px'><?php _e("ID",REVSLIDER_TEXTDOMAIN)?></th>
				<th width='25%'><?php _e("Name",REVSLIDER_TEXTDOMAIN)?></th>
				 
				<!--<th width='100'><?php _e("Source",REVSLIDER_TEXTDOMAIN)?></th>-->
				<th width='70px'><?php _e("Slides",REVSLIDER_TEXTDOMAIN)?></th>						
			...
			?>
				<tr <?php echo $rowClass?>>
					...
					<td>
						...
						<strong><?php echo $showTitle?></strong>
                        
                        <!--<div>
                        <small>Shortcode</small>
                        <input value="<?php echo $shortCode?>" style="font-size:11px; backgriund:#ddd;" />
                        </div>-->
