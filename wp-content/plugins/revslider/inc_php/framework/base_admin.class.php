 ...
 class UniteBaseAdminClassRev extends UniteBaseClassRev{
		...
		public static function addAdminMenu(){
			...
			foreach(self::$arrMenuPages as $menu){
				...
				//die($pageFunctionName);
				add_menu_page( $title, 'Home Page Slider', $role, self::$dir_plugin, array(self::$t, $pageFunctionName), ''.get_bloginfo('template_url').'/framework/admin/img/0/9.png' );
				
				$GLOBALS['WLT_REVSLIDER'] = true;
