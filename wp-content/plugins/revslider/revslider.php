...
Description: This plugin will add new slider options to your PremiumPress theme.
Author: ThemePunch / Modified for PremiumPress themes.
Version: 1.0
*/
...
try{
	...
	echo _e("Slider Error:",REVSLIDER_TEXTDOMAIN)."<b>".$message."</b>";
}
