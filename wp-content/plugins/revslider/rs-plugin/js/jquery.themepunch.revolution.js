...
/**************************************************************************
 * jquery.themepunch.revolution.js - jQuery Plugin for Slider
					...
					return this.each(function() {
						...
						if (!container.hasClass("revslider-initialised")) {
									...
									if (versionTop==1 && versionMinor < 7) {
										container.html('<div style="text-align:center; padding:40px 0px; font-size:20px; color:#992222;"> The Current Version of jQuery:'+version+' <br>Please update your jQuery Version to min. 1.7 in Case you wish to use the Slider Plugin</div>');
									}
...
function revslider_showDoubleJqueryError(sliderID) {
	var errorMessage = "Slider Error: You have some jquery.js library include that comes after the revolution files js include.";
