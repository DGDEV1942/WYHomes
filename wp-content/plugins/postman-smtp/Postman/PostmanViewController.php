...
if (! class_exists ( 'PostmanViewController' )) {
	class PostmanViewController {
		...
		private function displayTopNavigation() {
			...
			print '<ul>';
			printf ( '<li><a href="%s" class="welcome-icon run-port-test">%s</a></li>', $this->getPageUrl ( PostmanConnectivityTestController::PORT_TEST_SLUG ), __ ( 'SMTP Connectivity Test', Postman::TEXT_DOMAIN ) );
