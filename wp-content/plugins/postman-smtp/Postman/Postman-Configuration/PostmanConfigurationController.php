...
class PostmanConfigurationController {
	...
	public function outputWizardContent() {
		...
		// Wizard Step 3
		printf ( '<h5>%s</h5>', __ ( 'SMTP Connectivity Test', Postman::TEXT_DOMAIN ) );
		print '<fieldset>';
		...
		printf ( '<p id="connectivity_test_status">%s: <span id="port_test_status">%s</span></p>', __ ( 'SMTP Connectivity Test', Postman::TEXT_DOMAIN ), _x ( 'Ready', 'TCP Port Test Status', Postman::TEXT_DOMAIN ) );
