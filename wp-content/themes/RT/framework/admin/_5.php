...
<div class="span8">
    ...
    <div class="accordion  style1" id="listingsetup_according"> 
    ...
    <div class="accordion-group">
        ...
        <div class="accordion-heading" style="background:#fff;">
            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#listingsetup_according" href="#item0">
             <h4 style="margin:0xp;font-weight:bold;">
             <img src="<?php echo get_template_directory_uri(); ?>/framework/admin/img/icons/19.png">
             Listing Setup Options <span style="font-size:12px;">(view/hide)</span></h4> 
            </a>
        </div>
        ...
        <div id="item0" class="accordion-body collapse ">
            <div class="accordion-inner">
                ...
                <?php get_template_part('framework/admin/templates/admin', '5-settings' ); ?>          
                </div>
            </div> 
        </div>
    ...
    <div class="accordion-group">
        ...
        <div class="accordion-heading" style="background:#fff;">
            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#listingsetup_according" href="#item8">
             <h4 style="margin:0xp;font-weight:bold;">
             <img src="<?php echo get_template_directory_uri(); ?>/framework/admin/img/icons/49.png">
             Listing Expiry Options <span style="font-size:12px;">(view/hide)</span></h4> 
            </a>
        </div>
        
        <div id="item8" class="accordion-body collapse ">
            <div class="accordion-inner">
                <div class="innerwrap content">        
                <?php get_template_part('framework/admin/templates/admin', '5-expire' ); ?>          
                </div>
            </div> 
        </div>
     ...
     <div class="accordion-group">
        ...
        <div class="accordion-heading" style="background:#fff;">
            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#listingsetup_according" href="#item6">
             <h4 style="margin:0xp;font-weight:bold;">
             <img src="<?php echo get_template_directory_uri(); ?>/framework/admin/img/icons/45.png">
             Attachment Options <span style="font-size:12px;">(view/hide)</span></h4> 
            </a>
        </div>
        
        <div id="item6" class="accordion-body collapse">
            <div class="accordion-inner">
                <div class="innerwrap content">        
                <?php get_template_part('framework/admin/templates/admin', '5-uploads' ); ?>          
                </div>
            </div> 
        </div>
    ...
    <div class="accordion-group">
        ...
        <div class="accordion-heading" style="background:#fff;">
            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#listingsetup_according" href="#item1">
             <h4 style="margin:0xp;font-weight:bold;">
             <img src="<?php echo get_template_directory_uri(); ?>/framework/admin/img/icons/google.png">
             Google Maps <span style="font-size:12px;">(view/hide)</span></h4> 
            </a>
        </div>
        ...
        <div id="item1" class="accordion-body collapse">
            <div class="accordion-inner">
                <div class="innerwrap content">        
                <?php get_template_part('framework/admin/templates/admin', '5-google' ); ?>          
                </div>
            </div> 
        </div>
    ...
    <div class="accordion-group">
        ...
        <div class="accordion-heading" style="background:#fff;">
            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#listingsetup_according" href="#item2">
             <h4 style="margin:0xp;font-weight:bold;">
             <img src="<?php echo get_template_directory_uri(); ?>/framework/admin/img/icons/15.png">
            Category &amp; Membership Access  <span style="font-size:12px;">(view/hide)</span></h4> 
            </a>
        </div>
        ...
        <div id="item2" class="accordion-body collapse">
            <div class="accordion-inner">
                <div class="innerwrap content">        
                <?php get_template_part('framework/admin/templates/admin', '5-category' ); ?>          
                </div>
            </div> 
        </div>
    ...
    <div class="accordion-group">
        ...
        <div class="accordion-heading" style="background:#fff;">
            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#listingsetup_according" href="#item7">
             <h4 style="margin:0xp;font-weight:bold;">
             <img src="<?php echo get_template_directory_uri(); ?>/framework/admin/img/icons/47.png">
            Custom Page Text  <span style="font-size:12px;">(view/hide)</span></h4> 
            </a>
        </div>
        ...
        <div id="item7" class="accordion-body collapse">
            <div class="accordion-inner">
                <div class="innerwrap content">        
                <?php get_template_part('framework/admin/templates/admin', '5-text' ); ?>          
                </div>
            </div> 
        </div>
...
<a data-toggle="modal" href="#VideoModelBox" class="btn btn-warning youtube" onclick="PlayPPTVideo('OJtUBPC1MwU','videoboxplayer','479','350');" style="width:100%; margin-bottom:10px; ">Watch Video Tutorial</a>
...
<div class="box gradient">
      ...
      <div class="title">
            <div class="row-fluid"> <h3> <i class="gicon-wrench"></i>Listing Status</h3></div>
        </div> 
...
<p>This is the default status for all newly created listing unless the user pays for a listing in which case it goes live straight away regardless of choice.</p>
</div>
...
<div class="box gradient">
      ...
      <div class="title">
            <div class="row-fluid"> <h3> <i class="gicon-horn"></i>Listing Approval</h3></div>
        </div> 
        
        <div class="content">
        
        <div style="padding:10px; background:#fff; border:1px dashed green;">
<p><span class="label label-info">Note</span> This will require you to manually approval all listings after they have been edited by the user.</p>
</div>
        

                    <div class="form-row control-group row-fluid ">
                            <label class="control-label span6" rel="tooltip" data-original-title="This will hide all listings with a blank or invalid listing expiry date." data-placement="top">Enable Approval</label>
                            <div class="controls span5">
                              <div class="row-fluid">
                                <div class="pull-left">
                                  <label class="radio off">
                                  <input type="radio" name="toggle" 
                                  value="off" onchange="document.getElementById('default_listing_approval').value='0'">
                                  </label>
                                  <label class="radio on">
                                  <input type="radio" name="toggle"
                                  value="on" onchange="document.getElementById('default_listing_approval').value='1'">
                                  </label>
                                  <div class="toggle <?php if($core_admin_values['default_listing_approval'] == '1'){  ?>on<?php } ?>">
                             ...
                             <input type="hidden" class="row-fluid" id="default_listing_approval" name="admin_values[default_listing_approval]" 
                             value="<?php echo $core_admin_values['default_listing_approval']; ?>">
         </div> 
...
<!--------------------------- LANGUAGE TAB ---------------------------->
<div class="tab-pane fade  <?php if(isset($_POST['tab']) && $_POST['tab'] == "submission"){ echo "active in"; } ?>" id="submission">
...
<div class="row-fluid">
    ...
    <div class="box gradient span8">
      ...
      <div class="title">
            ...
            <h3><i class="gicon-list"></i>Fields</h3></div>
        </div><!-- End .title -->
    ...
    <a data-toggle="modal" href="#VideoModelBox" class="btn btn-warning youtube" onclick="PlayPPTVideo('lFHXg-wdqR4','videoboxplayer','479','350');" style="width:100%; margin-bottom:10px; ">Watch Video Tutorial</a>
...
<a data-toggle="modal" href="#VideoModelBox" class="btn btn-warning youtube" onclick="PlayPPTVideo('NPy8HKdyikk','videoboxplayer','479','350');" style="float:right; ">Watch Video Tutorial</a>
   ...
   <div id="piechart2" style="width: 566px; height: 500px;"></div>
    ...
    <div class="span4">
        ...
        <tr>
                  ...
                  <td>Not Assigned <a href="javascript:void(0);" rel="tooltip" data-original-title="This count includes members which have a membership assigned but are not covered by those above." data-placement="top"><img  src="<?php echo get_template_directory_uri(); ?>/framework/admin/img/info.png" align="absmiddle" style="float:right;padding-right:10px;"></a></td>
                  <td><?php echo $CORE->COUNTUSER('wlt_membership',$mk1,false); ?></td>
                </tr>
                
                 <tr>
                  
                  <td>Everything Else <a href="javascript:void(0);" rel="tooltip" data-original-title="This count includes all users without a membership assigned." data-placement="top"><img  src="<?php echo get_template_directory_uri(); ?>/framework/admin/img/info.png" align="absmiddle" style="float:right;padding-right:10px;"></a></td>
...
<div class="row-fluid">
    ...
    <div class="box gradient span8">
      ...
      <div class="title">
            ...
            <h3><i class="gicon-list-alt"></i>Memberships</h3></div>
        </div><!-- End .title -->
    ...
    <div class="box gradient span4">
      <div class="title">
            <div class="row-fluid">
                <h3><i class="gicon-cog"></i>Extra Settings</h3>
            </div>
        </div><!-- End .title -->
        <div class="content">
...
<a data-toggle="modal" href="#VideoModelBox" class="btn btn-warning youtube" onclick="PlayPPTVideo('FkhrHXcEI_I','videoboxplayer','479','350');" style="float:right; ">Watch Video Tutorial</a>
   ...
   <div id="piechart" style="width: 566px; height: 500px;"></div>
    ...
    <div class="span4">
        ...
        <tr>
                  ...
                  <td>Not Assigned <a href="javascript:void(0);" rel="tooltip" data-original-title="This count includes listing which have a package assigned but are not covered by those above. Such packages usually refer to ones which have been deleted and/or no longer exist." data-placement="top"><img  src="<?php echo get_template_directory_uri(); ?>/framework/admin/img/info.png" align="absmiddle" style="float:right;padding-right:10px;"></a></td>
                  <td><?php echo $CORE->COUNT('packageID',$pk1,false); ?></td>
                </tr>
                
                 <tr>
                  
                  <td>Everything Else <a href="javascript:void(0);" rel="tooltip" data-original-title="This count includes listings (published and drafted) which have not been assigned a listing package." data-placement="top"><img  src="<?php echo get_template_directory_uri(); ?>/framework/admin/img/info.png" align="absmiddle" style="float:right;padding-right:10px;"></a></td>
...
<div class="row-fluid"> 
    <div class="box gradient span8">
      ...
      <div class="title">
            ...
            <h3><i class="gicon-list-alt"></i>Listing Packages</h3></div>
        </div><!-- End .title -->
    ...
    <div class="box gradient span4">
     ...
     <div class="title">
            <div class="row-fluid">
                <h3><i class="gicon-wrench"></i>Listing Enhancements</h3>
            </div>
     </div><!-- End .title -->
     <div class="content">
...
<div class="row-fluid">
<div class="span6" style="font-size:11px;" rel="tooltip" data-original-title="Listings will show up with a colored bacground in search results." data-placement="top">Featured</div>
<div class="span6">
    <div class="input-prepend row-fluid span6">
...
<hr />
    ...
    <div class="form-row row-fluid ">
                            <label class="control-label span7" rel="tooltip" data-original-title="Turn ON to allow users to upgrade their listing packages." data-placement="top">Upgrade Options</label>
                            <div class="controls span4">
                              <div class="row-fluid">
                                <div class="pull-left">
                                  <label class="radio off">
           ...
           <div class="form-row control-group row-fluid">
                ...
                <div class="controls span7">
                  ...
                  <option></option>
				   ...
				   $ee = "";
				   if(isset($_GET['edit_submission_field']) && isset($submissionfields[$_GET['edit_submission_field']]['package']) && in_array($field['ID'], $submissionfields[$_GET['edit_submission_field']]['package']) ){
           ...
           <!--
            <div class="form-row row-fluid">
                ...
                <div class="input-append row-fluid">
                  ...
                  <span class="add-on" id="upload_pakimage"><i class="gicon-globe"></i></span>
                  </div>
                </div>
            </div>  
          ...
          <!--
            <div class="form-row row-fluid">
                ...
                <div class="input-append row-fluid">
                  ...
                  <span class="add-on" id="upload_pakimage1"><i class="gicon-globe"></i></span>
                  </div>
                </div>
            </div> 
    ...
    <div class="form-row row-fluid">
              ...
              <div class="span6"> 
                  ...
                  <option></option>
				   ...
				   $ee = "";
				   if(isset($_GET['edit_membership_field']) && isset($membershipfields[$_GET['edit_membership_field']]['package']) && $field['ID'] == $membershipfields[$_GET['edit_membership_field']]['package']  ){
