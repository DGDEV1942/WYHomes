...
if(!defined('WLT_DEMOMODE')){
	...
	if(isset($_GET['delete_file']) && is_numeric($_GET['delete_file'] )){
		...
		// SAVE ARRAY DATA
		update_option( "wlt_languagefiles", $wlt_languagefiles, true);
...
<h3> Text</h3></div><div class="content">
...
<div class="span4">
 ...
 <a data-toggle="modal" href="#VideoModelBox" class="btn btn-warning youtube" onclick="PlayPPTVideo('hRNP1p2F-7c','videoboxplayer','479','350');" style="width:100%; margin-bottom:10px; ">Watch Video Tutorial</a>



<div class="box gradient"><div class="title"><div class="row-fluid"><h3>Live Text Editor</h3></div></div><div class="content">


<div class="form-row row-fluid">

 <div style="padding:10px; background:#fff; border:1px dashed green;  margin-bottom:10px;">
Turn ON and you will be able to edit language file text live on the front end of the website.   
         </div>
			...
			<div class="form-row row-fluid span11 ">
                            <label class="control-label span7">Text Editor</label>
...
<div class="box gradient"><div class="title"><div class="row-fluid"><h3> GEO User Languages</h3></div></div><div class="content">

 <div style="padding:10px; background:#fff; border:1px dashed green;  margin-bottom:10px;">
Turn ON and the theme will try and load a suitable language file based on the users location. 
 </div>
 
 
 <?php if(!isset($core_admin_values['geolanguage'])){ $core_admin_values['geolanguage'] = 0; } ?>
