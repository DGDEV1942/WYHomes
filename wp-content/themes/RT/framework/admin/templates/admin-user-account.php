...
?> 
 ...
 <div class="heading2">Display Layout</div> 
  ...
  <div class="form-row control-group row-fluid ">
                                <label class="control-label span5 offset3" rel="tooltip" data-original-title="This will change the display of your my account page boxes." data-placement="top">Layout Style</label>
                                <div class="controls span4">
                                  <div class="row-fluid">
                                    <div class="pull-left">
                                      <label class="radio off">
                                      <input type="radio" name="toggle" 
                                      value="off" onchange="document.getElementById('account_layout').value='0'">
                                      </label>
                                      <label class="radio on">
                                      <input type="radio" name="toggle"
                                      value="on" onchange="document.getElementById('account_layout').value='1'">
                                      </label>
                                      <div class="toggle <?php if($core_admin_values['account_layout'] == '1'){  ?>on<?php } ?>">
                                        <div class="yes">LIST</div>
                                 ...
                                 <input type="hidden" class="row-fluid" id="account_layout" name="admin_values[account_layout]" 
                                 value="<?php echo $core_admin_values['account_layout']; ?>">
    </div> 
