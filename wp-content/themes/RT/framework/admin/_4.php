...
class Walker_CategorySelection2 extends Walker_Category {  
	...
	switch($_GET['task']){
		...
		$nc->reset_customizer();
		echo "<h1>Customizer Settings Deleted Successfull</h1>";
		die();
		} break;		
}
}
...
<div class="tab-pane fade <?php if(isset($_POST['tab']) && $_POST['tab'] == "catimport"){ echo "active in"; } ?>" id="catimport">
    ...
    <div class="row-fluid">
        ...
        <div class="title"><h4><i class="gicon-tags"></i><span>Bulk Category Import</span></h4></div>
...
<div class="row-fluid">
    ...
    <div class="span6">
        ...
        <div class="box gradient">
        <div class="title">
          <h4><i class="gicon-tags"></i><span>System Reset</span></h4>
        </div>
            <div class="content top">
...
<div class="clearfix"></div>
            ...
            <div class="box gradient">
        <div class="title">
          <h4><i class="gicon-refresh"></i><span>Listing Changes</span></h4>
        </div>
            <div class="content top">
...
<?php } ?>
        ...
        <div class="box gradient">
        <div class="title">
          <h4><i class="gicon-refresh"></i><span>Color Customizer</span></h4>
        </div>
            <div class="content top">
            
            <div class="well">	
<b>Reset All Colors</b>	 
 <a href="admin.php?page=4&amp;task=resetcustomizer&amp;TB_iframe=true&amp;width=640&amp;height=100" class="alertme button right" >Reset Colors</a> 
<div class="clearfix"></div>
</div> 
...
jQuery('.alertme').click(function(e)
{
    ...
    else
    {
     ...
     <div class="box gradient">
    <div class="title"><h4><i class="gicon-ban-circle"></i><span>System Cleanup Modules</span></h4></div>
        <div class="content top ">
...
<a href="admin.php?page=4&amp;task=delete71&amp;TB_iframe=true&amp;width=640&amp;height=100" class="alertme button right" >Delete All Listings</a>
<div class="clearfix"></div>
</div>
<?php } ?>
