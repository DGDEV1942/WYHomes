...
// TAXONOMY TOP
function hook_taxonomy_content_top($c){   return  apply_filters('hook_taxonomy_content_top', $c);   }
...
function hook_content_templatename($c){ return  apply_filters('hook_content_templatename', $c);  }
	...
	function hook_menu_style5($c){ return  apply_filters('hook_menu_style5', $c);  }
	...
	function hook_gallerypage_searchform(){  do_action('hook_gallerypage_searchform');  } 
	...
	// TAXONOMY PAGE
	function hook_taxonomy_title_before(){  do_action('hook_taxonomy_title_before');  }
	function hook_taxonomy_title_after(){  do_action('hook_taxonomy_title_after');  }
	...
	function hook_admin_1_tabs($c){   return  apply_filters('hook_admin_1_tabs', $c);   }
  	function hook_admin_1_content(){  do_action('hook_admin_1_content');  }
		...
		// PAGE 2
		function hook_admin_1_logo_top(){  do_action('hook_admin_1_logo_top');  }
		
		function hook_admin_1_topnav_top(){  do_action('hook_admin_1_topnav_top');  }
	...
	// SELLSPACE BANNER LIST
	function hook_sellspace($c){ return  apply_filters('hook_sellspace', $c);  } 
