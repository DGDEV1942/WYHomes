...
require_once TEMPLATEPATH ."/framework/class/class_colors.php";
require_once TEMPLATEPATH ."/framework/class/class_functions.php";
require_once TEMPLATEPATH ."/framework/class/class_widgets.php";
require_once TEMPLATEPATH ."/framework/class/class_core.php";
require_once TEMPLATEPATH ."/framework/class/class_media.php";
...
$THEME_SHORTCODES	= new core_shortcodes;  
...
if(defined('WLT_VIDEO')){
	// LOAD IN COUPON DEFAULTS
	if(file_exists(TEMPLATEPATH .'/framework/class/defaults_video.php')){
	require_once TEMPLATEPATH .'/framework/class/defaults_video.php';
	$CORE_VIDEO	= new core_videos;
	}
} //end if
