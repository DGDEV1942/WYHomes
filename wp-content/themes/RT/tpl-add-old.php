<?php
/*
Template Name: [Add Listing (old design)]
*/
/* =============================================================================
...
// HCECK FOR 1 LISTING ONLY, IF SO REDIRECT
if($GLOBALS['CORE_THEME']['onelistingonly'] == 1 && $userdata->ID && !isset($_GET['eid']) && !isset($_POST['action']) ){
...
// MIN OF 200 CHARACTERS FOR LISTING LENGHT
